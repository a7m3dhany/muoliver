...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/R1_O9) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/R1_O9) /ZE \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/R1_O9)\n [𝗦𝗢𝗨𝗥𝗖𝗘 𝗢&𝗥](https://t.me/R1_O9)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/R1_O9) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/Ql_ll0"),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/R1_O9) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/R1_O9) \n ※[These Features AI Based](https://t.me/R1_O9)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="R1_O9"),
                ],
                [                
                    InlineKeyboardButton(" Commands", callback_data="cbcmds"),
                    InlineKeyboardButton(" Donate", url=f"https://t.me/R1_O9"),
                ],
                [
                    InlineKeyboardButton(
                        " DEVELOPER ", url="https://t.me/R1_O9"
                    )
                ],
            ]
        ),
...
@Client.on_callback_query(filters.regex("R1_O9"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🖤 **※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع او ار من هن : @R1_O9 **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
